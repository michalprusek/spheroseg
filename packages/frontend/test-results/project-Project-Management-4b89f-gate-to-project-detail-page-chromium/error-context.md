...
- Name: Project Management >> should navigate to project detail page
- Location: /home/cvat/spheroseg/spheroseg/packages/frontend/e2e/project.spec.ts:47:3
...
Call log:
  - waiting for locator('input[type="email"]')
    ...
    at /home/cvat/spheroseg/spheroseg/packages/frontend/e2e/project.spec.ts:7:47
```
