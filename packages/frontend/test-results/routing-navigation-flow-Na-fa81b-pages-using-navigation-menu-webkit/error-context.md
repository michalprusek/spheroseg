...
- Name: Navigation Flow and Links >> should navigate between pages using navigation menu
- Location: /home/cvat/spheroseg/spheroseg/packages/frontend/e2e/routing/navigation-flow.spec.ts:8:3
