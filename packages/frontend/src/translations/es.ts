export default {
  ...
  "projects": {
    ...
    "confirmDeleteDescription": "Esta acción no se puede deshacer. Todos los datos asociados con este proyecto se eliminarán permanentemente.",
  ...
  "settings": {
    ...
    "deleteAccountWarning": "Una vez que elimines tu cuenta, no hay vuelta atrás. Todos tus datos serán eliminados permanentemente.",
  ...
  "auth": {
    ...
    "enterEmailForReset": "Ingresa tu dirección de correo electrónico y te enviaremos un enlace para restablecer tu contraseña",
    "passwordResetLinkSent": "Si existe una cuenta con este correo electrónico, se ha enviado un enlace para restablecer la contraseña",
    ...
    "signUpSuccessEmail": "Registro exitoso! Por favor, revisa tu correo electrónico o espera la aprobación del administrador.",
  ...
  "hero": {
    ...
    "subtitle": "Eleva tu análisis de imágenes celulares microscópicas con nuestra plataforma de segmentación de esferoides de vanguardia. Diseñada para investigadores que buscan precisión y eficiencia.",
    ...
    "welcomeDescription": "Nuestra plataforma combina algoritmos de inteligencia artificial de vanguardia con una interfaz intuitiva para la detección y análisis precisos de esferoides celulares en imágenes microscópicas.",
    ...
    "featureAiSegmentationDesc": "Detección precisa de esferoides con análisis de límites para mediciones celulares exactas.",
    "featureEditing": "Análisis Impulsado por IA",
    "featureEditingDesc": "Aproveche los algoritmos de aprendizaje profundo para la detección y clasificación celular automatizada.",
    ...
    "ctaSubtitle": "Únase a los investigadores líderes que ya están utilizando nuestra plataforma para acelerar sus descubrimientos.",
  ...
  "index": {
    "about": {
      ...
      "paragraph1": "SpheroSeg es una plataforma avanzada diseñada específicamente para la segmentación y análisis de esferoides celulares en imágenes microscópicas.",
      "paragraph2": "Nuestra herramienta combina algoritmos de inteligencia artificial de vanguardia con una interfaz intuitiva para proporcionar a los investigadores detección precisa de bordes de esferoides y capacidades analíticas.",
      "paragraph3": "La plataforma fue desarrollada por Michal Průšek de FNSPE CTU en Praga bajo la supervisión de Adam Novozámský de UTIA CAS, en colaboración con investigadores del Departamento de Bioquímica y Microbiología de UCT Praga.",
      "contactPrefix": "prusemic@cvut.cz"
    },
    "cta": {
  ...
  "termsPage": {
    ...
    "acceptance": {
      ...
      "paragraph1": "Al acceder o utilizar SpheroSeg, aceptas estar sujeto a estos Términos de Servicio y a todas las leyes y regulaciones aplicables. Si no estás de acuerdo con alguno de estos términos, se te prohíbe usar este servicio."
    },
    "useLicense": {
      "title": "2. Licencia de Uso",
      "paragraph1": "Se concede permiso para utilizar temporalmente SpheroSeg solo para fines personales, no comerciales o de investigación académica. Esto es la concesión de una licencia, no una transferencia de título."
    },
    "dataUsage": {
      "title": "3. Uso de Datos",
      "paragraph1": "Cualquier dato subido a SpheroSeg sigue siendo de tu propiedad. No reclamamos la propiedad de tu contenido, pero requerimos ciertos permisos para proporcionar el servicio."
    },
    "limitations": {
      "title": "4. Limitaciones",
      "paragraph1": "En ningún caso SpheroSeg será responsable por cualquier daño que surja del uso o la imposibilidad de usar la plataforma, incluso si se nos ha notificado la posibilidad de dicho daño."
    },
    "revisions": {
      "title": "5. Revisiones y Erratas",
      "paragraph1": "Los materiales que aparecen en SpheroSeg podrían incluir errores técnicos, tipográficos o fotográficos. No garantizamos que ninguno de los materiales sea preciso, completo o actual."
    },
    "governingLaw": {
      "title": "6. Ley Aplicable",
      "paragraph1": "Estos términos y condiciones se rigen e interpretan de acuerdo con las leyes del país en el que se aloja el servicio, y te sometes irrevocablemente a la jurisdicción exclusiva de los tribunales de esa ubicación."
    }
  },
  "statsOverview": {
    "totalProjects": "Total de proyectos",
  ...
  "privacyPage": {
    ...
    "introduction": {
      ...
      "paragraph1": "Esta Política de Privacidad explica cómo SpheroSeg (\"nosotros\", \"nos\", \"nuestro\") recopila, utiliza y comparte tu información cuando utilizas nuestra plataforma para la segmentación y análisis de esferoides."
    },
    "informationWeCollect": {
      "title": "2. Información que Recopilamos",
      "paragraph1": "Recopilamos información que nos proporcionas directamente cuando creas una cuenta, subes imágenes, creas proyectos y de otras formas interactúas con nuestros servicios."
    },
    "personalInformation": {
      "title": "2.1 Información Personal",
      "paragraph1": "Esto incluye tu nombre, dirección de correo electrónico, institución/organización y otra información que proporcionas al configurar tu cuenta o solicitar acceso a nuestros servicios."
    },
    "researchData": {
      "title": "2.2 Datos de Investigación",
      "paragraph1": "Esto incluye imágenes que subes, detalles del proyecto, resultados de análisis y otros datos relacionados con la investigación que creas o subes a nuestra plataforma."
    },
    "usageInformation": {
      "title": "2.3 Información de Uso",
      "paragraph1": "Recopilamos información sobre cómo utilizas nuestra plataforma, incluidos datos de registro, información del dispositivo y patrones de uso."
    },
    "howWeUse": {
      "title": "3. Cómo Utilizamos tu Información",
      "paragraph1": "Utilizamos la información que recopilamos para proporcionar, mantener y mejorar nuestros servicios, para comunicarnos contigo y para cumplir con nuestras obligaciones legales."
    },
    "dataSecurity": {
      "title": "4. Seguridad de Datos",
      "paragraph1": "Implementamos medidas de seguridad apropiadas para proteger tu información personal y datos de investigación contra acceso, alteración, divulgación o destrucción no autorizados."
    },
    "dataSharing": {
      "title": "5. Compartición de Datos",
      "paragraph1": "No vendemos tu información personal ni datos de investigación. Podemos compartir tu información en circunstancias limitadas, como con tu consentimiento, para cumplir con obligaciones legales o con proveedores de servicios que nos ayudan a operar nuestra plataforma."
    },
    "yourChoices": {
      "title": "6. Tus Opciones",
      "paragraph1": "Puedes acceder, actualizar o eliminar la información de tu cuenta y datos de investigación a través de la configuración de tu cuenta. También puedes contactarnos para solicitar acceso, corrección o eliminación de cualquier información personal que tengamos sobre ti."
    },
    "changes": {
      "title": "7. Cambios en esta Política",
      "paragraph1": "Podemos actualizar esta Política de Privacidad de vez en cuando. Te notificaremos de cualquier cambio publicando la nueva Política de Privacidad en esta página y actualizando la fecha de \"Última Actualización\"."
    },
    "contactUs": {
      "title": "8. Contáctanos",
      "paragraph1": "Si tienes alguna pregunta sobre esta Política de Privacidad, por favor contáctanos en privacy@spheroseg.com."
    },
  ...
  "editor": {
    ...
    "sliceWarningInvalidIntersections": "Corte no válido: la línea de corte debe intersecar el polígono en exactamente dos puntos.",
  ...
  "projects": {
    ...
    "duplicateProjectDescription": "Crea una copia de este proyecto incluyendo todas las imágenes. Puedes personalizar las opciones a continuación.",
    ...
    "duplicateProgressDescription": "Tu proyecto está siendo duplicado. Este proceso puede llevar algo de tiempo para proyectos grandes.",
    ...
    "deleteWarning": "Esta acción no se puede deshacer. Todos los datos asociados con este proyecto se eliminarán permanentemente.",
