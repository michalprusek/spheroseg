...
export default {
  ...
  project: {
    ...
    deleteConfirmation: '¿Está seguro de que desea eliminar el proyecto "{{projectName}}"? Esta acción no se puede deshacer.',
    duplicateProject: 'Duplicar Proyecto',
    duplicateDescription: 'Crear una copia de este proyecto. El nuevo proyecto se creará con el nombre que proporcione a continuación.',
  ...
  projectsPage: {
    ...
    duplicateProject: 'Duplicar proyecto',
    duplicateProjectDescription: 'Crear una copia de este proyecto incluyendo todas las imágenes. Puede personalizar las opciones a continuación.',
    ...
    duplicateProgressDescription: 'Su proyecto está siendo duplicado. Este proceso puede tomar tiempo para proyectos grandes.',
  ...
  documentation: {
    ...
    segmentationProcess: {
      ...
      automatic: {
        ...
        paragraph1: 'Nuestra segmentación automática potenciada por IA puede detectar límites de esferoides con alta precisión:',
      ...
      manual: {
        ...
        paragraph1: 'A veces la segmentación automática puede requerir refinamiento. Nuestro editor proporciona herramientas para:',
  ...
  hero: {
    ...
    featureEditingDesc: 'Aproveche algoritmos de aprendizaje profundo para detección automatizada y clasificación celular.',
  ...
  index: {
    ...
    cta: {
      ...
      boxText: 'Obtenga acceso a todas las características de la plataforma y comience a analizar sus imágenes microscópicas',
      button: 'Crear Cuenta',
    },
  },
  tools: {
  ...
  privacyPage: {
    ...
    contactUs: {
      title: '8. Contáctenos',
      paragraph1: 'Si tiene alguna pregunta sobre esta Política de Privacidad, por favor contáctenos en privacy@spheroseg.com.',
    },
  ...
  projectActions: {
    ...
    deleteConfirmDesc: '¿Está seguro de que desea eliminar el proyecto "{{projectName}}"? Esta acción no se puede deshacer.',
  ...
  editor: {
    ...
    sliceWarningInvalidIntersections: 'División inválida: La línea de corte debe intersectar el polígono en exactamente dos puntos.',
  ...
  privacyPage: {
    ...
    introduction: {
      title: '1. Introducción',
      paragraph1: 'En SpheroSeg, nos comprometemos a proteger su privacidad. Esta Política de Privacidad explica qué información recopilamos, cómo la usamos y cuáles son sus derechos con respecto a su información.',
    },
    dataCollection: {
      title: '2. Información que Recopilamos',
      paragraph1: 'Recopilamos información que usted nos proporciona directamente, incluyendo:',
      list: [
        'Información de la cuenta (correo electrónico, nombre, institución)',
        'Imágenes y datos cargados para segmentación',
        'Metadatos del proyecto y resultados del análisis',
    ...
    dataUsage: {
      ...
      list: [
        ...
        'Garantizar la seguridad y prevenir el abuso',
      ],
    },
    dataStorage: {
      title: '4. Almacenamiento y Seguridad de Datos',
      paragraph1: 'Implementamos medidas técnicas y organizativas apropiadas para proteger su información personal contra acceso no autorizado, alteración, divulgación o destrucción.',
      paragraph2: 'Sus datos se almacenan en servidores seguros y se eliminan de acuerdo con nuestra política de retención de datos.',
    },
    dataSharing: {
      title: '5. Compartir Datos',
      paragraph1: 'No vendemos, intercambiamos ni transferimos su información personal a terceros sin su consentimiento, excepto según lo descrito en esta política o según lo requiera la ley.',
    },
    userRights: {
    ...
    cookies: {
      ...
      paragraph1: 'Usamos cookies y tecnologías similares para mejorar su experiencia, analizar el uso del sitio y personalizar el contenido.',
    },
    changes: {
      title: '8. Cambios en Esta Política',
      paragraph1: 'Podemos actualizar nuestra Política de Privacidad de vez en cuando. Le notificaremos sobre cualquier cambio publicando la nueva Política de Privacidad en esta página.',
    },
    contact: {
      title: '9. Contáctenos',
      paragraph1: 'Si tiene preguntas sobre esta Política de Privacidad, contáctenos en:',
