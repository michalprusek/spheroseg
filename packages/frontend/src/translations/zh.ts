export default {
  ...
  hero: {
    ...
    welcomeDescription: "我们的平台结合了先进的人工智能算法和直观的界面，为显微镜图像中的细胞类器官提供精确检测和分析。",
    featuresTitle: "强大功能",
  ...
  index: {
    about: {
      ...
      paragraph3: "该平台由布拉格FNSPE CTU的Michal Průšek在UTIA CAS的Adam Novozámský的指导下开发，并与UCT布拉格生物化学与微生物学系的研究人员合作完成。",
      contactPrefix: "prusemic@cvut.cz"
    },
    cta: {
      title: "准备好改变您的研究方式了吗？",
