export default {
  ...
  requestAccess: {
    ...
    description:
      'Füllen Sie das untenstehende Formular aus, um Zugriff auf unsere Plattform anzufordern. Wir werden Ihre Anfrage prüfen und uns bald bei Ihnen melden.',
  ...
  projectActions: {
    ...
    deleteConfirmDesc:
      'Möchten Sie das Projekt "{{projectName}}" wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden.',
  ...
  auth: {
    ...
    signUpSuccessEmail:
      'Registrierung erfolgreich! Bitte überprüfen Sie Ihre E-Mail oder warten Sie auf die Genehmigung durch den Administrator.',
    ...
    passwordResetLinkSent:
      'Wenn ein Konto für diese E-Mail existiert, wurde ein Link zum Zurücksetzen des Passworts gesendet',
  ...
  hero: {
    ...
    subtitle:
      'Verbessern Sie Ihre mikroskopische Zellbildanalyse mit unserer hochmodernen Plattform zur Spheroid-Segmentierung. Entwickelt für Forscher, die Präzision und Effizienz suchen.',
    ...
    welcomeDescription:
      'Unsere Plattform kombiniert modernste KI-Algorithmen mit einer intuitiven Benutzeroberfläche für die präzise Erkennung und Analyse von Zellspheroiden in mikroskopischen Bildern.',
    ...
    featureEditingDesc:
      'Nutzen Sie Deep-Learning-Algorithmen für die automatisierte Zellerkennung und -klassifizierung.',
  ...
  index: {
    about: {
      ...
      paragraph1:
        'SpheroSeg ist eine fortschrittliche Plattform, die speziell für die Segmentierung und Analyse von Zellspheroiden in mikroskopischen Bildern entwickelt wurde.',
      paragraph2:
        'Unser Tool kombiniert modernste Algorithmen der künstlichen Intelligenz mit einer intuitiven Benutzeroberfläche, um Forschern präzise Spheroid-Grenzerkennung und analytische Fähigkeiten zu bieten.',
      paragraph3:
        'Die Plattform wurde von Michal Průšek von der FNSPE CTU in Prag unter der Leitung von Adam Novozámský vom UTIA CAS entwickelt, in Zusammenarbeit mit Forschern der Abteilung für Biochemie und Mikrobiologie der UCT Prag.',
      contactPrefix: 'prusemic@cvut.cz',
    },
    cta: {
      ...
      boxText:
        'Erhalten Sie Zugang zu allen Funktionen der Plattform und beginnen Sie mit der Analyse Ihrer mikroskopischen Bilder',
  ...
  shortcuts: {
    ...
    save: 'Speichern',
    description:
      'Diese Tastenkürzel funktionieren innerhalb des Segmentierungseditors für schnelleres und bequemeres Arbeiten.',
  },
  imageProcessor: {
  ...
  segmentationPage: {
    ...
    resegmentationTimeout:
      'Zeitüberschreitung bei der Neusegmentierung. Bitte überprüfen Sie den Status der Warteschlange.',
  ...
  projectsPage: {
    ...
    duplicateProjectDescription:
      'Erstellen Sie eine Kopie dieses Projekts einschließlich aller Bilder. Sie können die untenstehenden Optionen anpassen.',
