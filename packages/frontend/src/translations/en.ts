...
export default {
  ...
  about: {
    ...
    team: {
      ...
      member3: {
        name: 'Research Team',
        role: 'Department of Biochemistry and Microbiology, UCT Prague',
      },
    },
    contact: {
      title: 'Contact Us',
  ...
  auth: {
    ...
    emailHasPendingRequest: 'This email has a pending request',
    emailPlaceholder: 'Enter your email',
    ...
    signUpSuccessEmail: 'Please check your email to verify your account',
  ...
  profile: {
    ...
    aboutMe: 'About Me',
    activityDescription: 'Your recent activity',
    analyses: 'Analyses',
    avatarHelp: 'Upload a profile picture',
    avatarImageOnly: 'Image files only',
    ...
    cropAvatarDescription: 'Adjust your profile picture',
