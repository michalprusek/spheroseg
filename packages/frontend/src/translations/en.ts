...
export default {
  ...
  export: {
    formatDescriptions: {
      ...
      DATUMARO: 'Datumaro format - unified dataset representation',
      CVAT_MASKS: 'CVAT XML format with polygon annotations',
      CVAT_YAML: 'CVAT YAML format for annotation interchange',
    },
