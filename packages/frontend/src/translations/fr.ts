...
export default {
  ...
  termsPage: {
    ...
    acceptance: {
      title: '1. Acceptation des Conditions',
      paragraph1: 'En accédant ou en utilisant SpheroSeg, vous acceptez d\'être lié par ces Conditions d\'Utilisation. Si vous n\'acceptez pas ces conditions, veuillez ne pas utiliser notre service.',
    },
    useLicense: {
      title: '2. Licence d\'Utilisation',
      paragraph1: 'SpheroSeg vous accorde une licence limitée, non exclusive et non transférable pour utiliser le service à des fins de recherche et d\'enseignement. L\'utilisation commerciale nécessite un accord de licence séparé.',
    },
    dataUsage: {
      title: '3. Utilisation des Données',
      paragraph1: 'Vous conservez tous les droits sur les images et données que vous téléchargez. Nous ne partageons pas vos données avec des tiers sans votre consentement explicite. Vos données sont utilisées uniquement pour fournir et améliorer nos services de segmentation.',
    },
    limitations: {
      title: '4. Limitations du Service',
      paragraph1: 'SpheroSeg est fourni "tel quel" sans aucune garantie. Nous ne garantissons pas une disponibilité, une précision ou une fiabilité à 100%. Les utilisateurs sont responsables de la validation des résultats pour leurs applications spécifiques.',
    },
    revisions: {
      title: '5. Révisions',
      paragraph1: 'Nous nous réservons le droit de modifier ces conditions à tout moment. Les modifications prendront effet immédiatement après leur publication. Votre utilisation continue du service constitue une acceptation des conditions modifiées.',
    },
    governingLaw: {
      title: '6. Droit Applicable',
      paragraph1: 'Ces conditions sont régies par les lois de la République tchèque. Tout litige sera résolu par les tribunaux compétents de Prague.',
    },
  ...
  privacyPage: {
    ...
    introduction: {
      title: '1. Introduction',
      paragraph1: 'Chez SpheroSeg, nous nous engageons à protéger votre vie privée. Cette Politique de Confidentialité explique quelles informations nous collectons, comment nous les utilisons et quels sont vos droits concernant vos informations.',
    },
    dataCollection: {
      title: '2. Informations que Nous Collectons',
      paragraph1: 'Nous collectons les informations que vous nous fournissez directement, notamment :',
      list: [
        'Informations de compte (e-mail, nom, institution)',
        'Images et données téléchargées pour la segmentation',
        'Métadonnées du projet et résultats d\'analyse',
    ...
    dataStorage: {
      ...
      paragraph1: 'Nous mettons en œuvre des mesures techniques et organisationnelles appropriées pour protéger vos informations personnelles contre l\'accès non autorisé, l\'altération, la divulgation ou la destruction.',
    ...
    dataSharing: {
      ...
      paragraph1: 'Nous ne vendons, n\'échangeons ni ne transférons vos informations personnelles à des tiers sans votre consentement, sauf comme décrit dans cette politique ou conformément à la loi.',
    },
    userRights: {
      title: '6. Vos Droits',
    ...
    cookies: {
      ...
      paragraph1: 'Nous utilisons des cookies et des technologies similaires pour améliorer votre expérience, analyser l\'utilisation du site et personnaliser le contenu.',
    },
    changes: {
      title: '8. Modifications de Cette Politique',
      paragraph1: 'Nous pouvons mettre à jour notre Politique de Confidentialité de temps en temps. Nous vous informerons de tout changement en publiant la nouvelle Politique de Confidentialité sur cette page.',
    },
    contact: {
      title: '9. Nous Contacter',
      paragraph1: 'Si vous avez des questions concernant cette Politique de Confidentialité, contactez-nous à :',
