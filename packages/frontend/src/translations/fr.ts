export default {
  ...
  "settings": {
    ...
    "deleteAccountWarning": "Une fois que vous supprimez votre compte, il n'y a pas de retour en arrière. Toutes vos données seront supprimées de façon permanente.",
  ...
  "hero": {
    ...
    "subtitle": "Améliorez votre analyse d'images cellulaires microscopiques avec notre plateforme de pointe pour la segmentation des sphéroïdes. Conçue pour les chercheurs en quête de précision et d'efficacité.",
    ...
    "welcomeDescription": "Notre plateforme combine des algorithmes d'intelligence artificielle de pointe avec une interface intuitive pour une détection et une analyse précises des sphéroïdes cellulaires dans les images microscopiques.",
    ...
    "featureAiSegmentationDesc": "Détection précise des sphéroïdes avec analyse des contours pour des mesures cellulaires précises.",
  ...
  "features": {
    ...
    "cards": {
      ...
      "aiAnalysis": {
        ...
        "description": "Utilisez des algorithmes d'apprentissage profond pour la détection et la classification automatisées des cellules"
      },
      "uploads": {
  ...
  "index": {
    "about": {
      ...
      "paragraph1": "SpheroSeg est une plateforme avancée conçue spécifiquement pour la segmentation et l'analyse des sphéroïdes cellulaires dans les images microscopiques.",
      "paragraph2": "Notre outil combine des algorithmes d'intelligence artificielle de pointe avec une interface intuitive pour fournir aux chercheurs une détection précise des contours des sphéroïdes et des capacités analytiques.",
      "paragraph3": "La plateforme a été développée par Michal Průšek de FNSPE CTU à Prague sous la supervision d'Adam Novozámský de l'UTIA CAS, en collaboration avec des chercheurs du Département de Biochimie et Microbiologie de l'UCT Prague.",
      "contactPrefix": "prusemic@cvut.cz"
    },
    "cta": {
      ...
      "boxText": "Accédez à toutes les fonctionnalités de la plateforme et commencez à analyser vos images microscopiques",
  ...
  "shortcuts": {
    ...
    "save": "Enregistrer",
    "description": "Ces raccourcis fonctionnent dans l'éditeur de segmentation pour un travail plus rapide et plus pratique."
  },
  "imageProcessor": {
  ...
  "editor": {
    ...
    "sliceWarningInvalidIntersections": "Découpe invalide: La ligne de coupe doit intersecter le polygone à exactement deux points.",
  ...
  "projects": {
    ...
    "duplicateProjectDescription": "Créer une copie de ce projet incluant toutes les images. Vous pouvez personnaliser les options ci-dessous.",
    ...
    "duplicateProgressDescription": "Votre projet est en cours de duplication. Ce processus peut prendre du temps pour les projets volumineux.",
