export default {
  ...
  common: {
    ...
    ready: 'Připraveno',
    // File upload texts
    clickToUpload: 'Klikněte pro nahrání souborů nebo přetáhněte soubory sem',
    fileUploadInput: 'Vstup pro nahrání souboru',
    clickToSelectFiles: 'Klikněte pro výběr souborů',
    orDragAndDrop: 'nebo přetáhněte soubory sem',
    // Success messages
    languageUpdated: 'Jazyk byl úspěšně aktualizován',
    // Pluralization helpers
    imagesCount: '{{count}} obrázků',
    imagesCount_one: '{{count}} obrázek',
    imagesCount_few: '{{count}} obrázky',
    imagesCount_other: '{{count}} obrázků',
  },
  // Error messages
  errors: {
    somethingWentWrong: 'Něco se pokazilo',
    componentError: 'V této komponentě došlo k chybě. Byli jsme upozorněni a problém co nejdříve vyřešíme.',
    errorDetails: 'Podrobnosti chyby',
    tryAgain: 'Zkusit znovu',
    reloadPage: 'Obnovit stránku',
    goBack: 'Jít zpět',
    notFound: '404',
    pageNotFoundMessage: 'Oops! Stránka nebyla nalezena',
    returnToHome: 'Návrat na domovskou stránku',
  },
  requestAccess: {
  ...
  settings: {
    ...
    deleteAccountDescription: 'Tento krok je nevratný. Všechna vaše data budou trvale smazána.',
    confirmUsername: 'Potvrďte svůj email',
    password: 'Heslo',
    ...
    changePasswordDescription: 'Změňte své heslo pro zachování bezpečnosti účtu',
  ...
  auth: {
    ...
    checkYourEmail: 'Zkontrolujte svůj email pro nové heslo',
    enterEmailForReset: 'Zadejte svůj email a pošleme vám nové heslo',
    passwordResetLinkSent: 'Pokud účet s tímto emailem existuje, bylo odesláno nové heslo',
    passwordResetFailed: 'Nepovedlo se odeslat nové heslo. Zkuste to prosím znovu.',
  ...
  footer: {
    ...
    by: 'od',
    allRightsReserved: '© 2025 SpheroSeg. Všechna práva vyhrazena.',
  },
  features: {
    tag: 'Funkce',
  ...
  errors: {
    somethingWentWrong: 'Něco se pokazilo',
    componentError: 'Došlo k chybě v této komponentě. Byli jsme upozorněni a problém vyřešíme co nejdříve.',
    errorDetails: 'Detaily chyby',
    tryAgain: 'Zkusit znovu',
    reloadPage: 'Obnovit stránku',
    goBack: 'Jít zpět',
    notFound: '404',
    pageNotFoundMessage: 'Oops! Stránka nenalezena',
    returnToHome: 'Zpět domů',
  ...
  share: {
    ...
    edit: 'Upravit',
    email: 'E-mail',
    failedToCopy: 'Nepodařilo se zkopírovat odkaz',
    failedToGenerateLink: 'Nepodařilo se vygenerovat odkaz pro sdílení',
    failedToLoadShares: 'Nepodařilo se načíst sdílené uživatele',
    failedToRemove: 'Nepodařilo se odstranit sdílení',
    failedToShare: 'Nepodařilo se sdílet projekt',
    ...
    linkGenerated: 'Odkaz pro sdílení vygenerován',
    ...
    selectAccessLevel: 'Vyberte úroveň přístupu',
    selectPermission: 'Prosím vyberte typ oprávnění',
