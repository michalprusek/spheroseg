export default {
  ...
  "documentation": {
    ...
    "introduction": {
      ...
      "whatIs": {
        ...
        "paragraph1": "SpheroSeg je pokročilá platforma navržená speciálně pro segmentaci a analýzu buněčných sféroidů v mikroskopických snímcích. Náš nástroj kombinuje špičkové algoritmy umělé inteligence s intuitivním rozhraním, aby poskytl výzkumníkům přesnou detekci hranic sféroidů a analytické schopnosti.",
        "paragraph2": "Tato platforma byla vyvinuta Bc. Michalem Průškem, studentem Fakulty jaderné a fyzikálně inženýrské ČVUT v Praze, pod vedením Ing. Adama Novozámského, Ph.D. Projekt vznikl ve spolupráci s výzkumníky z Ústavu biochemie a mikrobiologie VŠCHT Praha.",
        "paragraph3": "SpheroSeg řeší náročný úkol přesné identifikace a segmentace hranic sféroidů v mikroskopických snímcích, což je kritický krok v mnoha biomedicínských výzkumných postupech zahrnujících modely 3D buněčných kultur."
      }
    },
    "gettingStarted": {
      "title": "Začínáme",
      "accountCreation": {
        ...
        "paragraph1": "Pro používání SpheroSeg si musíte vytvořit účet. To nám umožňuje bezpečně ukládat vaše projekty a obrázky.",
      ...
      "creatingProject": {
        ...
        "paragraph1": "Projekty vám pomáhají organizovat vaši práci. Každý projekt může obsahovat více obrázků a jejich odpovídající výsledky segmentace.",
    ...
    "segmentationProcess": {
      ...
      "paragraph1": "Proces segmentace identifikuje hranice sféroidů ve vašich obrázcích, což umožňuje přesnou analýzu jejich morfologie.",
      "automatic": {
        "title": "Automatická segmentace",
        "paragraph1": "Naše automatická segmentace poháněná umělou inteligencí dokáže detekovat hranice sféroidů s vysokou přesností:",
    ...
    "apiReference": {
      "title": "API Reference",
      "paragraph1": "SpheroSeg nabízí RESTful API pro programový přístup k funkcím platformy. To je ideální pro integraci s vašimi stávajícími pracovními postupy nebo dávkové zpracování.",
  ...
  "auth": {
    ...
    "signUpSuccessEmail": "Registrace byla úspěšná! Zkontrolujte prosím svůj e-mail nebo vyčkejte na schválení administrátorem.",
  ...
  "hero": {
    ...
    "subtitle": "Zlepšete analýzu mikroskopických snímků buněk pomocí naší špičkové platformy pro segmentaci sféroidů. Navrženo pro výzkumníky hledající přesnost a efektivitu.",
    ...
    "welcomeDescription": "Naše platforma kombinuje špičkové algoritmy umělé inteligence s intuitivním rozhraním pro přesnou detekci a analýzu buněčných sféroidů v mikroskopických snímcích.",
  ...
  "index": {
    "about": {
      ...
      "paragraph1": "SpheroSeg je pokročilá platforma navržená speciálně pro segmentaci a analýzu buněčných sféroidů v mikroskopických snímcích.",
      "paragraph2": "Náš nástroj kombinuje špičkové algoritmy umělé inteligence s intuitivním rozhraním, aby poskytl výzkumníkům přesnou detekci hranic sféroidů a analytické schopnosti.",
      "paragraph3": "Platforma byla vyvinuta Michalem Průškem z FJFI ČVUT v Praze pod vedením Adama Novozámského z ÚTIA AV ČR, ve spolupráci s výzkumníky z Ústavu biochemie a mikrobiologie VŠCHT Praha.",
      "contactPrefix": "prusemic@cvut.cz"
    },
    "cta": {
  ...
  "termsPage": {
    ...
    "acceptance": {
      ...
      "paragraph1": "Přístupem nebo používáním SpheroSeg souhlasíte s tím, že budete vázáni těmito Podmínkami služby a všemi platnými zákony a předpisy. Pokud nesouhlasíte s některou z těchto podmínek, je vám zakázáno používat tuto službu."
    },
    "useLicense": {
      "title": "2. Licence k použití",
      "paragraph1": "Je udělena licence k dočasnému používání SpheroSeg pouze pro osobní, nekomerční nebo akademické výzkumné účely. Toto je udělení licence, nikoli převod vlastnického práva."
    },
    "dataUsage": {
      "title": "3. Použití dat",
      "paragraph1": "Veškerá data nahraná do SpheroSeg zůstávají vaším majetkem. Nenárokujeme si vlastnictví vašeho obsahu, ale požadujeme určitá oprávnění k poskytování služby."
    },
    "limitations": {
      "title": "4. Omezení",
      "paragraph1": "V žádném případě nebude SpheroSeg odpovědný za jakékoli škody vyplývající z používání nebo nemožnosti používat platformu, i když jsme byli upozorněni na možnost takové škody."
    },
    "revisions": {
      "title": "5. Revize a chyby",
      "paragraph1": "Materiály zobrazené na SpheroSeg mohou obsahovat technické, typografické nebo fotografické chyby. Nezaručujeme, že jakékoli materiály jsou přesné, úplné nebo aktuální."
    },
    "governingLaw": {
      "title": "6. Rozhodné právo",
      "paragraph1": "Tyto podmínky se řídí a vykládají v souladu se zákony země, ve které je služba hostována, a neodvolatelně se podřizujete výlučné jurisdikci soudů v dané lokalitě."
    }
  },
  "statsOverview": {
    "totalProjects": "Celkem projektů",
  ...
  "privacyPage": {
    ...
    "introduction": {
      "title": "1. Úvod",
      "paragraph1": "Tyto Zásady ochrany osobních údajů vysvětlují, jak SpheroSeg (\"my\", \"nás\", \"naše\") shromažďuje, používá a sdílí vaše informace, když používáte naši platformu pro segmentaci a analýzu sféroidů."
    },
    "informationWeCollect": {
      "title": "2. Informace, které shromažďujeme",
      "paragraph1": "Shromažďujeme informace, které nám přímo poskytnete, když si vytvoříte účet, nahrajete obrázky, vytvoříte projekty a jinak interagujete s našimi službami."
    },
    "personalInformation": {
      "title": "2.1 Osobní údaje",
      "paragraph1": "To zahrnuje vaše jméno, e-mailovou adresu, instituci/organizaci a další informace, které poskytnete při zakládání účtu nebo žádosti o přístup k našim službám."
    },
    "researchData": {
      "title": "2.2 Výzkumná data",
      "paragraph1": "To zahrnuje obrázky, které nahrajete, detaily projektu, výsledky analýz a další data souvisejících s výzkumem, která vytvoříte nebo nahrajete na naši platformu."
    },
    "usageInformation": {
      "title": "2.3 Informace o používání",
      "paragraph1": "Shromažďujeme informace o tom, jak používáte naši platformu, včetně protokolových dat, informací o zařízení a vzorců používání."
    },
    "howWeUse": {
      "title": "3. Jak používáme vaše informace",
      "paragraph1": "Informace, které shromažďujeme, používáme k poskytování, údržbě a zlepšování našich služeb, ke komunikaci s vámi a k plnění našich právních povinností."
    },
    "dataSecurity": {
      "title": "4. Zabezpečení dat",
      "paragraph1": "Zavádíme vhodná bezpečnostní opatření k ochraně vašich osobních údajů a výzkumných dat před neoprávněným přístupem, změnou, zveřejněním nebo zničením."
    },
    "dataSharing": {
      "title": "5. Sdílení dat",
      "paragraph1": "Neprodáváme vaše osobní údaje ani výzkumná data. Vaše informace můžeme sdílet za omezených okolností, například s vaším souhlasem, pro splnění právních povinností nebo s poskytovateli služeb, kteří nám pomáhají provozovat naši platformu."
    },
    "yourChoices": {
      "title": "6. Vaše volby",
      "paragraph1": "Můžete přistupovat, aktualizovat nebo mazat informace o svém účtu a výzkumná data prostřednictvím nastavení účtu. Můžete nás také kontaktovat a požádat o přístup, opravu nebo výmaz jakýchkoli osobních údajů, které o vás máme."
    },
    "changes": {
      "title": "7. Změny těchto zásad",
      "paragraph1": "Tyto Zásady ochrany osobních údajů můžeme čas od času aktualizovat. O jakýchkoli změnách vás budeme informovat zveřejněním nových Zásad ochrany osobních údajů na této stránce a aktualizací data \"Poslední aktualizace\"."
    },
    "contactUs": {
      "title": "8. Kontaktujte nás",
      "paragraph1": "Pokud máte jakékoli dotazy ohledně těchto Zásad ochrany osobních údajů, kontaktujte nás prosím na privacy@spheroseg.com."
    },
  ...
  "projects": {
    ...
    "confirmDeleteDescription": "Tato akce nemůže být vrácena. Všechna data spojená s tímto projektem budou trvale smazána.",
    ...
    "duplicateProjectDescription": "Vytvořte kopii tohoto projektu včetně všech obrázků. Můžete přizpůsobit možnosti níže.",
