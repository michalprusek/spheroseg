...
import {
  ZoomIn, ZoomOut, Expand, Eye, Edit, PlusSquare, Share2, Trash2, Undo2, Redo2, Save, MousePointer, Scissors, RefreshCw
} from 'lucide-react';
...
export const ToolbarV2: React.FC<ToolbarV2Props> = ({
  ...
  return (
    <div className="flex flex-col items-center space-y-1 p-2 bg-background border-r border-border h-full overflow-y-auto" style={{ minWidth: '50px' }}>
      {/* View Controls */}
      <Button
        variant="ghost"
        size="icon"
