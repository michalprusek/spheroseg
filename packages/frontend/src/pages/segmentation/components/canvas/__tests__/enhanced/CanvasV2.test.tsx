...
describe('CanvasV2 Component', () => {
  ...
  it('renders vertices for selected polygon in edit mode', async () => {
    ...
    render(<CanvasV2 {...defaultProps} selectedPolygonId="polygon-1" editMode={EditMode.EditVertices} />);
  ...
  it('renders special instructions for AddPoints mode', async () => {
    ...
    const { rerender } = render(<CanvasV2 {...defaultProps} editMode={EditMode.AddPoints} interactionState={null} />);
  ...
  it('applies the correct transform to SVG content', async () => {
    ...
    render(<CanvasV2 {...defaultProps} transform={{ zoom: 2, translateX: 100, translateY: 50 }} />);
...
describe('CanvasV2 Component - Edge Cases', () => {
  ...
  it('handles empty polygon array gracefully', async () => {
    render(<CanvasV2 {...defaultProps} segmentationData={{ polygons: [] }} />);
  ...
  it('handles extreme zoom values correctly', async () => {
    ...
    const { rerender } = render(<CanvasV2 {...defaultProps} transform={{ zoom: 0.1, translateX: 0, translateY: 0 }} />);
    ...
    rerender(<CanvasV2 {...defaultProps} transform={{ zoom: 10, translateX: 0, translateY: 0 }} />);
  ...
  it('handles negative translations correctly', async () => {
    render(<CanvasV2 {...defaultProps} transform={{ zoom: 1, translateX: -100, translateY: -50 }} />);
