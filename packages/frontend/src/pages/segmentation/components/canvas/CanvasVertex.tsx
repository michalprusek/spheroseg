...
interface CanvasVertexProps {
  ...
  polygonId: string;
  vertexIndex: number;
  onVertexMouseDown: (event: React.MouseEvent<SVGCircleElement>, polygonId: string, vertexIndex: number) => void;
  onVertexMouseEnter: (event: React.MouseEvent<SVGCircleElement>, polygonId: string, vertexIndex: number) => void;
  onVertexMouseLeave: (event: React.MouseEvent<SVGCircleElement>) => void;
