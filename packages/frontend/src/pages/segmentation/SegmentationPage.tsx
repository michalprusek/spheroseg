            ...
            <div className="h-screen flex flex-col items-center justify-center p-4 bg-gray-50 dark:bg-gray-900">
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 max-w-md w-full text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-6">
                        {error ?
                            error :
                            t('segmentation.imageNotFoundDescription') || 'The image you\'re trying to access doesn\'t exist or has been deleted.'}
                    </p>
    ...
    return (
        <div className="h-screen flex flex-col bg-background text-foreground">
            ...
            <StatusBarV2
                ...
                vertexCount={segmentationData?.polygons?.reduce((count, polygon) => count + (polygon.points?.length || 0), 0) || 0}
