...
export const useSlicingMode = (
  ...
  const handleSlicingClick = useCallback((x: number, y: number): boolean => {
    console.log('[handleSlicingClick Debug] Called.', { x, y, slicingMode, selectedPolygonId, sliceStartPoint });
    ...
    console.log(`[SLICE DEBUG] Attempting to slice from (${sliceStartPoint.x.toFixed(2)}, ${sliceStartPoint.y.toFixed(2)}) to (${x.toFixed(2)}, ${y.toFixed(2)})`);
