...
export const useVertexDrag = (
  ...
  const handleVertexDrag = useCallback((
    ...
    if (polygonId !== null && vertexIndex !== null) {
      if (!containerElement) {
        console.error('[handleVertexDrag] containerElement is undefined', { e, polygonId, vertexIndex, segmentation });
        return false;
      }
  ...
  const handleVertexClick = useCallback((
    ...
    console.log('[handleVertexClick] ENTRY', { clientX, clientY, containerElement, segmentation, vertexDragState: vertexDragState?.current });
    if (!segmentation) return false;

    if (!containerElement) {
      console.error('[handleVertexClick] containerElement is undefined', { clientX, clientY, segmentation });
      return false;
    }
