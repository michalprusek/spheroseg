      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className={`${getMutedTextClasses()} mb-6 max-w-md`}>
        ...
        <div className={`border-t ${getBorderClasses()} mt-12 pt-8 text-center ${getMutedTextClasses()}`}>
          ...
          <p className="mt-2 text-sm flex items-center justify-center">
            {getTranslation('footer.madeWith') || "Made with"} <Heart className="w-4 h-4 mx-1 text-red-500" /> {getTranslation('footer.by') || "by"} Michal Průšek
          </p>
        </div>
      </div>
    </footer>
