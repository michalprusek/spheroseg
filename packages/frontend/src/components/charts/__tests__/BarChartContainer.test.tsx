...
describe('BarChartContainer Component', () => {
  ...
  it('renders chart container with correct config', () => {
    render(<BarChartContainer data={testData} config={testConfig} bars={testBars} />);
  ...
  it('uses custom color for bar if provided', () => {
    ...
    render(<BarChartContainer data={testData} config={testConfig} bars={barsWithCustomColor} />);
  ...
  it('uses fallback color if no color provided in config or bar props', () => {
    ...
    render(<BarChartContainer data={testData} config={incompleteConfig} bars={testBars} />);
