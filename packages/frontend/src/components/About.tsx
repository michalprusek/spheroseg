          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center animate-on-scroll">
              <div className="glass-morphism rounded-2xl overflow-hidden">
                <img
                  src="/assets/illustrations/8f483962-36d5-4bae-8c90-c9542f8cc2d8.png"
              ...
              <div className="space-y-6">
                <p className="text-gray-600 dark:text-gray-300">
                  {t('index.about.paragraph1')}
                </p>
                <p className="text-gray-600 dark:text-gray-300">
                  {t('index.about.paragraph2')}
                </p>
                <p className="text-gray-600 dark:text-gray-300">
                  {t('index.about.paragraph3')}
                </p>
                <p className="text-gray-600 dark:text-gray-300">
                  <a href="mailto:prusemic@cvut.cz" className="text-blue-600 dark:text-blue-400 hover:underline">prusemic@cvut.cz</a>
                </p>
              </div>
            </div>
          </div>
