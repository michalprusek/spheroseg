...
describe('FileList Component', () => {
  ...
  it('renders nothing when files array is empty', () => {
    const { container } = render(
      <FileList files={[]} uploadProgress={0} onRemoveFile={mockOnRemoveFile} />
    );
  ...
  it('renders file items when files are provided', () => {
    render(
      <FileList files={mockFiles} uploadProgress={50} onRemoveFile={mockOnRemoveFile} />
    );
  ...
  it('shows file size in appropriate format', () => {
    render(
      <FileList files={mockFiles} uploadProgress={0} onRemoveFile={mockOnRemoveFile} />
    );
  ...
  it('shows upload progress for uploading files', () => {
    render(
      <FileList files={mockFiles} uploadProgress={75} onRemoveFile={mockOnRemoveFile} />
    );
