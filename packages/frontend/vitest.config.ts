...
export default defineConfig({
  ...
  test: {
    ...
    exclude: ['**/node_modules/**', '**/dist/**', '**/cypress/**', '**/.{idea,git,cache,output,temp}/**', '**/__tests__/e2e/**', '**/__tests__/visual-regression/**', '**/*.visual.spec.ts', '**/e2e/**', '**/*.e2e.spec.ts', '**/*.playwright.spec.ts'],
  },
  resolve: {
    alias: {
