...
describe('Image Routes', () => {
  ...
  beforeEach(() => {
    ...
    router.get('/projects/:projectId/images', (req, res) => {
      ...
      const projectImages = Array.from(mockImages.values()).filter((image) => image.project_id === projectId);
  ...
  describe('GET /api/projects/:projectId/images', () => {
    it('should return a list of images for a project', async () => {
      const response = await request(app).get(`/api/projects/${testProjectId}/images`);
    ...
    it('should return 404 if project not found', async () => {
      const response = await request(app).get('/api/projects/nonexistent-project/images');
  ...
  describe('GET /api/projects/:projectId/images/:imageId', () => {
    it('should return a specific image', async () => {
      const response = await request(app).get(`/api/projects/${testProjectId}/images/${testImageId}`);
    ...
    it('should return 404 if image not found', async () => {
      const response = await request(app).get(`/api/projects/${testProjectId}/images/nonexistent-image`);
    ...
    it('should return 404 if project not found', async () => {
      const response = await request(app).get(`/api/projects/nonexistent-project/images/${testImageId}`);
  ...
  describe('DELETE /api/projects/:projectId/images/:imageId', () => {
    it('should delete an image and return 204', async () => {
      const response = await request(app).delete(`/api/projects/${testProjectId}/images/${testImageId}`);
    ...
    it('should return 404 if image not found', async () => {
      const response = await request(app).delete(`/api/projects/${testProjectId}/images/nonexistent-image`);
    ...
    it('should return 404 if project not found', async () => {
      const response = await request(app).delete(`/api/projects/nonexistent-project/images/${testImageId}`);
  ...
  describe('GET /api/projects/:projectId/images/:imageId/verify', () => {
    it('should verify an image exists and return status', async () => {
      const response = await request(app).get(`/api/projects/${testProjectId}/images/${testImageId}/verify`);
    ...
    it('should return 404 if image not found', async () => {
      const response = await request(app).get(`/api/projects/${testProjectId}/images/nonexistent-image/verify`);
  ...
  describe('Legacy Routes', () => {
    it('should redirect DELETE /api/images/:id to the new route', async () => {
      const response = await request(app).delete(`/api/images/${testImageId}`).redirects(0); // Don't follow redirects
    ...
    it('should redirect GET /api/verify/:id to the new route', async () => {
      const response = await request(app).get(`/api/verify/${testImageId}`).redirects(0); // Don't follow redirects
