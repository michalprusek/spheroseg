 ...
 * Create a test image
 */
export async function createTestImage(projectId: string, overrides: Partial<{
  name: string;
  filename: string;
 ...
 * Clean up test data
 */
export async function cleanupTestData(userIds: string[] = [], projectIds: string[] = [], imageIds: string[] = []) {
