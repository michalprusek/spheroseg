...
describe('projectDuplicationService', () => {
  describe('generateNewFilePaths', () => {
    ...
    it('should handle complex file names with multiple dots', () => {
      ...
      expect(result.newThumbnailPath).toBe('/uploads/new-project-id/thumb-thumb-complex.file.name-copy-12345-500000.jpg');
  ...
  describe('duplicateProject', () => {
    ...
    it('should handle project not found or access denied', async () => {
      ...
      await expect(duplicateProject(
        ...
        'original-project-id',
        'test-user'
      )).rejects.toThrow('Original project not found or access denied');
  ...
  describe('duplicateProjectViaApi', () => {
    ...
    it('should handle API errors', async () => {
      ...
      // Act & Assert
      await expect(duplicateProjectViaApi(
        'https://api.example.com',
        'original-project-id',
        'test-token'
